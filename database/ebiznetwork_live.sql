...
-- Corrected: 2026-09-18 UTC
-- Fixes CREATE/INSERT mismatches and aligns affected tables with Laravel migrations.
-- =========================================================================
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  KEY `users_referrer_id_index` (`referrer_id`)
...
CREATE TABLE IF NOT EXISTS `profiles` (
  ...
  `preferences_json` JSON NULL DEFAULT NULL,
  `created_at` TIMESTAMP NULL DEFAULT NULL,
  `updated_at` TIMESTAMP NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `campaigns` (
  ...
  `proof_requirements_json` JSON NULL DEFAULT NULL,
  ...
  `target_languages_json` JSON NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `tasks` (
  ...
  `status` ENUM('available','paused','completed') NOT NULL DEFAULT 'available',
  `created_at` TIMESTAMP NULL DEFAULT NULL,
  `updated_at` TIMESTAMP NULL DEFAULT NULL,
  `deleted_at` TIMESTAMP NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `task_assignments` (
  ...
  `user_id` BIGINT UNSIGNED NOT NULL,
  `status` ENUM('reserved','in_progress','submitted','completed','expired','cancelled') NOT NULL DEFAULT 'in_progress',
...
CREATE TABLE IF NOT EXISTS `task_submissions` (
  ...
  `updated_at` TIMESTAMP NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `task_submissions_uuid_unique` (`uuid`),
...
CREATE TABLE IF NOT EXISTS `withdrawal_requests` (
  ...
  `updated_at` TIMESTAMP NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `withdrawal_requests_uuid_unique` (`uuid`),
...
(5, 'support_email', 'support@ebizearn.com', 'support', 1, '2026-09-17 22:54:18', '2026-09-17 22:54:18');
